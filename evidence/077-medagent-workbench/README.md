# Evidence — Spec 077 MedAgent Workbench

## Index

Required evidence set (see `specs/077-medagent-workbench/plan.md`, section 077-J):
...
## Known workstation constraint (carried forward from Spec 075/076)

...
The external qualification was repeated in Rust `--release` profile on the current Apple M2 development Mac after the final artifact-byte bounds and verified-byte model/tokenizer loading hardening. The final pre-PR candidate observation was:

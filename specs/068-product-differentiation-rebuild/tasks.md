...
- [x] T1 Founder promotion after prior UI rejection.
- [x] T2 Reopen canonical project status and define 068–072 sequence.
- [x] T3 Replace the prior palette with the MedScale signal system.
- [x] T4 Rebuild shell/sidebar/topbar hierarchy and remove decorative multi-color branding.
- [x] T5 Add Models route and Rust-backed truth model.

...
- [x] T1 Close Spec 066 canonically and promote Spec 067.
- [x] T2 Add final UI product qualification regression.
- [x] T3 Replace stale final-UI-absent performance classification.

...
pub fn build_doctor_report_full(
    ...
    DoctorReport {
        ...
        vault_privacy: VaultPrivacyDoctorStatus::spec_043_honest(
            key_posture.os_keyring_available,
            key_posture.os_keyring_used,
            map_file_probe(probes.pagefile.existence),
            map_file_probe(probes.hibernate.existence),
            map_file_probe(probes.swap.existence),
            map_file_probe(probes.snapshot.existence),
            map_file_probe(probes.core_dump_config.existence),
            map_honesty(probes.pagefile.existence_honesty),
            map_honesty(probes.pagefile.protection_honesty),
            map_honesty(probes.swap.existence_honesty),
            map_honesty(probes.swap.protection_honesty),
            map_honesty(probes.snapshot.existence_honesty),
            map_honesty(probes.snapshot.protection_honesty),
            map_honesty(probes.core_dump_config.existence_honesty),
            map_honesty(probes.core_dump_config.protection_honesty),
        ),

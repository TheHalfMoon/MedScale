...
pub fn build_doctor_report_full(
    ...
    DoctorReport {
        ...
        notes: vec![
            ...
            "Release qualification READY_BASE (022+027+029+032+054+057+058): locked CI + macOS CI + perf/SBOM + NOTICE + deterministic unsigned portable package lifecycle; release_sbom_qualified=true; portable_release_package_qualified=true; package_lifecycle_qualified=true; reproducible_binary_build=unproven; macos_qualified=false; rights_license_decision=true (Apache-2.0); RELEASE_READY=false; budgets not claimed; branch protection configured (ruleset 23259329; main protected=true)".to_owned(),

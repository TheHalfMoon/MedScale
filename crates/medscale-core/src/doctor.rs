...
pub fn build_doctor_report_full(
    ...
    DoctorReport {
        ...
        notes: vec![
            ...
            "Release qualification READY_BASE (022+027+029+032+054): locked CI + macOS CI present + perf/SBOM + NOTICE inventory; release_sbom_qualified=true (CycloneDX 1.5, reproducible_build=unproven); macos_qualified=false; rights_license_decision=false; RELEASE_READY=false; budgets not claimed; branch protection EXTERNAL_GATES".to_owned(),

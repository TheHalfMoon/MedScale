...
pub use authority::{
    CoreFacade, DEFAULT_CORPUS_ID, DEFAULT_CORPUS_VERSION, SCALE_CORPUS_DOC_COUNT_10K,
    SCALE_CORPUS_ID, SCALE_CORPUS_VERSION_10K, admit_corpus_bytes, admit_corpus_dir,

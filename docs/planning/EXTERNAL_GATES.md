...
| FINAL_V0_UI_ARTIFACT | `USER_SUPPLIED_WHEN_READY` | Final visual implementation | Continue core/contracts/integration shell with deterministic fixture UI; do not invent final visual design. |

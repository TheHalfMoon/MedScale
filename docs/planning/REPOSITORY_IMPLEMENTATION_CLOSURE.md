...
No new implementation spec is authorized by this closure. Specs 068+ and mobile remain deferred unless freshly promoted. MESC is a separate project/repository and is excluded from MedScale completion and release criteria; historical Specs 012/036 are provenance only.

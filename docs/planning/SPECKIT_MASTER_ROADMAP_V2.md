...
| 049 | `package-upgrade-rollback` | Package upgrade/rollback dry-run scaffold (Q05 residual) | 047/048 closed | READY — package_upgrade_rollback_scaffold_present; RELEASE_READY=false |

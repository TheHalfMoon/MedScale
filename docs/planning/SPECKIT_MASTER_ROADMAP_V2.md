...
| 027+ | `research-site-imaging-genomics-advanced` | deferred site/research/collab/imaging/genomics/plugin/browser/watch/vision expansion | evidence-driven later gates | no Trusted V1 implementation commitment |
...
Next: 012 MESC-blocked; OS key/swap/snapshot still block PRIVATE_DATA_READY; 027+ deferred
```

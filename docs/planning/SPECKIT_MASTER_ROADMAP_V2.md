...
| 048 | `migration-recovery-release-bar` | Migration/recovery release-bar READY_BASE (Q05 residual) | 003/005/047 closed | READY — migration_recovery_ready_base; RELEASE_READY=false |
| 049+ | `research-site-imaging-genomics-advanced` | deferred site/research/collab/imaging/genomics/plugin/browser/watch/vision expansion | evidence-driven later gates | no Trusted V1 implementation commitment |

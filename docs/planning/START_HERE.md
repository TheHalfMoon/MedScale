...
Spec **050** is promoted READY (host perf measurement path; `host_perf_measurement_path_present`; budgets still not claimed; see `SPEC_050_PROMOTION.md`).
Spec 012 remains MESC-blocked. Deferred advanced work is **051+**.

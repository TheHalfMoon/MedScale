...
Spec **048** is promoted READY (migration/recovery release-bar READY_BASE; `migration_recovery_ready_base`; RELEASE_READY still FALSE; see `SPEC_048_PROMOTION.md`).
Spec 012 remains MESC-blocked. Deferred advanced work is **049+**.

...
Spec **057** and Spec **058** are `CLOSED_CANONICAL`; Spec 058 qualified deterministic unsigned portable package + install/upgrade/rollback on Windows/Linux/macOS. Spec **059** is `QUALIFIED_PENDING_MERGE` for final repository-owned release closure/material-findings audit; PR run `34889698756` passed all six required checks on `8845b347ff225e598fedd7ca014928b16b0367a0`. Spec 012 remains optional/deferred. Advanced work is **060+** and not a Trusted V1 completion requirement.

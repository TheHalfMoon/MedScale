...
**Closure evidence:** PR #99 merged as `0822f2e4dbc86ba43c0e1e43b9def07954750ca6`. Post-merge main CI run `34884057860` completed success with all six required jobs; portable release qualification/evidence upload succeeded on Ubuntu, Windows, and macOS.
